...
var removeItems = ['pizza', 'hotpockets', 'MtnDew', 'corndogs']
/*
  ...
  second is an item to remove from vamyGroceryList. If the second argument (or the item to add or remove) matches an item in myGroceryList,
...
*/
var removeItem = function(myGroceryList, removeItems) {
...
// var findOne = function(num1) {
//   for (var i = 0; i < num1; i++) {
//     arr1.push(i);
//   } return arr1
// }
    
// var findOne = function(num2) {
